...
from topo.tkgui.plotgrouppanel2 import AbstractPlotGroupPanel
...
class ModelEditor(AbstractPlotGroupPanel):
    ...
    arrow_tool = paramtk.Button(image_path="tkgui/icons/redo-small.png",
        size=button_image_size,
        doc="""Use the arrow tool to select and\nmove objects in the canvas around""")
...
#        arrow_tool.pack(side='top')
        ...
        self.pack_param('arrow_tool',parent=self.parent, on_set=lambda: self.canvas.change_mode('a'),side='top')
#        self.pack_param('arrow_tool',parent=self.parent, on_set=lambda: self.set_focus(True),side='top')
...
class ArrowTool(paramtk.TkParameterized,Frame):
    """
...
class NodeTool(Frame):
    ...
    def __init__(self, canvas,  parent = None, parambar = None):
        ...
        self.title_label.pack()
        self.icon = Canvas(self, width = 35, height = 30,bg = 'light grey')
        self.icon.create_polygon(10,0, 35,0, 25,30, 0,30, 
            fill = 'black', outline = 'white')
        self.icon.pack()
        self.icon.bind('<Button-1>', self.change_mode) # icon sets canvas mode
...
class ConnectionTool(Frame):
    ...
    def __init__(self, canvas, parent = None, parambar = None):
        ...
        self.icon = Canvas(self, width = 35, height = 30,bg = 'light grey')
        self.icon.create_polygon(17,0, 0,30, 35,30, 17,0, 
            fill = 'black', outline = 'white')
        self.icon.pack()
        self.icon.bind('<Button-1>', self.change_mode) # icon sets canvas mode
...
class ParametersTool(Frame):
    ...
    def __init__(self, parent = None):
        ...
        self.parameter_frame = paramtk.ParametersFrameWithApply(self)#,buttons_to_remove=['Close','Defaults'])
