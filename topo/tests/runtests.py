...
target['pickle'].append(topographica_script + " -c 'from topo.tests.test_script import pickle_unpickle_everything; errs = pickle_unpickle_everything(existing_pickles=\"%(pickle_path)s\"); import sys; sys.exit(errs)'"%dict(pickle_path=pickle_path))
