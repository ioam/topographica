...
This Topographica package is designed to be installed into an existing
Python environment (e.g. Python(x,y) on Windows, or EPD on
Mac). Please see http://Topographica.org/Downloads for instructions
and links to all packages.
