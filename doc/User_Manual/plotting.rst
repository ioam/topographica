...
#. To this plot group, add up to one plot per Sheet named
   "Orientation Preference", plotting any SheetMatrix named
...
long as it results in a SheetMatrix added to the appropriate
...
gravity, and builds a SheetMatrix out of that (rather than presenting
any input patterns).
