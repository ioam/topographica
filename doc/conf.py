# -*- coding: utf-8 -*-
#
# Topographica documentation build configuration file, created by
# sphinx-quickstart on Thu Jan 17 01:16:37 2013.
#
...
sys.path.insert(0, os.path.abspath('../external/imagen/'))
sys.path.insert(0, os.path.abspath('../external/lancet/'))
sys.path.insert(0, os.path.abspath('../external/param/'))
sys.path.insert(0, os.path.abspath('../external/paramtk/'))
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'inheritance_diagram']
...
htmlhelp_basename = 'Topographicadoc'
...
latex_documents = [
  ('index', 'Topographica.tex', u'Topographica Documentation',
   u'IOAM', 'manual'),
]
...
man_pages = [
    ('index', 'topographica', u'Topographica Documentation',
     [u'IOAM'], 1)
]
...
texinfo_documents = [
  ('index', 'Topographica', u'Topographica Documentation',
   u'IOAM', 'Topographica', 'One line description of project.',
   'Miscellaneous'),
]
