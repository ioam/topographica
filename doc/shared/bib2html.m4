...
m4_dnl
m4_dnl JABALERT: This file should be translated into PHP so that we do
m4_dnl not rely on m4; it should be an easy task for someone who knows PHP.
m4_dnl
...
m4_define([[m4_bib2html_command]],  [[env BIBINPUTS="shared//:" BSTINPUTS="shared//:" PATH="shared/bib2html:/bin:/usr/bin" bib2html -b "-min-crossrefs=9999"]])
m4_dnl
